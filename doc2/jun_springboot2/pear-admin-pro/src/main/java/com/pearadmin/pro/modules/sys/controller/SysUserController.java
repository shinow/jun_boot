...
import com.pearadmin.pro.common.tools.core.secure.SecureUtil;
...
public class SysUserController extends BaseController {
    ...
    @GetMapping("info")
    public Result info(){
        return success(SecureUtil.getPrincipal());
    }
    ...
    public Result menu(){
        ...
        menus.add(new SysMenu( "list", "ops-cache", "ops-cache", "menu", "DatabaseOutlined", "缓存监控", 0, "", false, true));
