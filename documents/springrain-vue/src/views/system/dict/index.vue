  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="字典类型" prop="typekey">
        <el-input
          v-model="queryParams.data.typekey"
          placeholder="请输入字典类型"
          clearable
          size="small"
          style="width: 240px"
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="字典编号" align="center" prop="sortno" />
      <el-table-column label="字典名称" align="center" prop="name" :show-overflow-tooltip="true" />
      <el-table-column label="字典类型" align="center" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          <router-link :to="'/dict/type/data/' + scope.row.typekey" class="link-type">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="字典类型" prop="typekey">
          <el-input v-model="form.typekey" placeholder="请输入字典类型" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
  ...
  methods: {
    ...
    getList() {
      ...
      listType(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
          ...
          this.total = response.page.totalCount || 0;
          this.loading = false;
        }
      );
    },
    ...
    statusFormat(row, column) {
      let statusName = this.selectDictLabel(this.statusOptions, row.status);
      return statusName;
    },
    // 取消按钮
    cancel() {
