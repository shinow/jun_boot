...
import com.hulk.lockd.handler.LockTimeoutHandler;
...
public enum LockTimeoutStrategy implements LockTimeoutHandler {
    ...
    FAIL_FAST() {
        ...
        public void handle(LockInfo lockInfo, Lock lock, JoinPoint joinPoint) {
            ...
            String errorMsg = String.format("Failed to acquire Lock(%s) with timeout(%ds)", lockInfo.getName(), lockInfo.getAcquireTimeout());
        ...
        public void handle(LockInfo lockInfo, Lock lock, JoinPoint joinPoint) {
            ...
            while(!lock.acquire()) {
                ...
                try {
                    ...
                    throw new LockdTimeoutException("Failed to acquire Lock", e);
                }
            }
        }
    }
