...
public class CommonController
{
    ...
    @RequiresPermissions("common:upload:img")
    ...
    public AjaxResult uploadImg(MultipartFile file) {
        try
        {
            ...
            ajax.put("fileName", fileName);
            ajax.put("url", url);
            uploadFileService.insertFile(fileName, url);
            UploadFile uploadFile = uploadFileService.selectByFileName(fileName);
            ajax.put("id", uploadFile.getId());
            return ajax;
        }
        catch (Exception e)
        {
