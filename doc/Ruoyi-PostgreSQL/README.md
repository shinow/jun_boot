# <font color=red> 针对若依框架修改了以下内容</font>
*  mysql改为了PostgreSQL
*  数据库密码加密  java -cp druid-1.1.14.jar com.alibaba.druid.filter.config.ConfigTools ****
*  添加了多租户的简单实现。http://localhost/ssoLogin?username=admin&branchId=1&authCode=23 
*  拷贝了其他项目的日志处理方式。
*  拷贝了其他项目的启动打印参数



<font color=red> 以下内容全部都是原作者的内容，比较懒</font>
