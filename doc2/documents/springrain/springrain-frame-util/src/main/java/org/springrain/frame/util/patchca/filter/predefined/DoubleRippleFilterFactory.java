 ...
 */
package org.springrain.frame.util.patchca.filter.predefined;

import org.springrain.frame.util.patchca.filter.AbstractFilterFactory;
import org.springrain.frame.util.patchca.filter.library.DoubleRippleImageOp;
