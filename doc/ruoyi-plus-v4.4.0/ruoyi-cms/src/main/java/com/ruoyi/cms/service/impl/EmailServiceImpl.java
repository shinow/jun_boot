...
public class EmailServiceImpl implements IEmailService 
{
    ...
    @Override
    public boolean sendEmailByTemplate(String template_code, String[] toEmails, Map<String,String> params) {
       Template template = templateService.selectTemplateByCode(template_code);
       if(template!=null){
           MailSenderInfo info=new MailSenderInfo();
           info.setMailServiceHost(CmsConfig.getMailHost());//qq邮箱服务器
           info.setMailServicePort(CmsConfig.getMailPort());//端口号
           ...
           info.setToAddress(toEmails);
           info.setSubject(template.getTemplateName());
