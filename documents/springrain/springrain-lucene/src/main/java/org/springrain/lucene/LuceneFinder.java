...
public class LuceneFinder {
     ...
     * @throws Exception
     */
    public List<BooleanClause> addWhereConditionRange(String fieldName, Class fieldType, Object minValue,
     ...
     */
    public List<BooleanClause> addWhereConditionRange(String fieldName, Class fieldType, Object minValue,
                                                      Object maxValue, boolean includeLower, boolean includeUpper, Occur occur) throws Exception {
