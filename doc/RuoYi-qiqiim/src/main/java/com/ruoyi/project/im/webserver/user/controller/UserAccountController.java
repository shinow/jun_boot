 ...
 */
@Controller
@RequestMapping("/im/useraccount")
public class UserAccountController extends IMBaseController{
	@Autowired
	...
	public Object list(@RequestParam Map<String, Object> params){
		...
		return putMsgToJsonString(IMConstants.WebSite.SUCCESS,"",total,userAccountList);
	}
	...
	public Object info(@PathVariable("id") Long id){
		...
		return putMsgToJsonString(IMConstants.WebSite.SUCCESS,"",0,userAccount);
	}
