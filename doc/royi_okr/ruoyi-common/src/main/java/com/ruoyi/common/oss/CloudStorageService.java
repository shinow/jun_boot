...
public abstract class CloudStorageService {
    ...
    public String getPath(String prefix) {
        ...
        //文件路径
        String path = System.currentTimeMillis()+ "/" + uuid;
     ...
     * @return
     */
    public abstract String downLoad(String fileKey, String path);
     ...
     * @return        返回http地址
     */
    public abstract String upload(String fileName,byte[] data);
    /**
     * 文件上传
