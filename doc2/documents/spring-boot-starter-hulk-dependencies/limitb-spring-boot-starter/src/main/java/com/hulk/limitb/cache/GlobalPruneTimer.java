...
public enum GlobalPruneTimer {
	...
	public void create() {
		...
		this.pruneTimer = new ScheduledThreadPoolExecutor(1, r -> newThread(r, String.format("Pure-Timer-%s",  cacheTaskNumber.getAndIncrement())));
	}
