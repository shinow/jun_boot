...
import com.project.system.service.impl.SysLogininforServiceImpl;
...
public class AsyncFactory {
     ...
     * @return 任务task
     */
    public static TimerTask recordLogininfor(final String username,final Long deptId, final String status, final String message, final Object... args) {
     ...
     * @return
     */
    public static TimerTask adjustDeptJbdmTask(final Long parentId){
        return new TimerTask() {
            @Override
            public void run() {
                try {
                    SpringUtils.getBean(SysDeptServiceImpl.class).adjustDeptJbdm(parentId);
                }catch (Exception e){
                    e.printStackTrace();
                }
            }
