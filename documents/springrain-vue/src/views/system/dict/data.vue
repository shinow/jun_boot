  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="字典名称" prop="typekey">
        <el-select v-model="queryParams.typekey" size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="字典编码" align="center" prop="pid" />
      <el-table-column label="字典标签" align="center" prop="name" />
      <el-table-column label="字典键值" align="center" prop="code" />
      <el-table-column label="字典排序" align="center" prop="sortno" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="字典类型">
          <el-input v-model="form.typekey" :disabled="true" />
        </el-form-item>
  ...
  methods: {
    ...
    getType(dictId) {
      ...
      getType(dictId).then(response => {
        debugger;
        that.queryParams.typekey = response.result.typekey;
        that.defaultDictType = response.result.typekey;
        that.getList();
      });
    },
    /** 查询字典类型列表 */
