...
-- 新增 Oauth2 模块
INSERT INTO ${_prefix}sys_module(module_code, module_name, description, main_class_name, current_version, upgrade_info, status, create_by, create_date, update_by, update_date, remarks)
VALUES ('oauth2', '第三方登录', '第三方登录模块、如：QQ、微信、Gitee、钉钉等', 'com.jeesite.modules.oauth2.web.Oauth2Controller', '4.2.0', NULL, '0', 'system', getdate(), 'system', getdate(), NULL);

-- 新增 Weixin 模块
INSERT INTO ${_prefix}sys_module(module_code, module_name, description, main_class_name, current_version, upgrade_info, status, create_by, create_date, update_by, update_date, remarks)
VALUES ('weixin', '微信接入', '微信公众号绑定、消息推送、微信其它接口调用', 'com.jeesite.modules.weixin.mp.web.WeixinLoginController', '4.2.0', NULL, '0', 'system', getdate(), 'system', getdate(), NULL);
