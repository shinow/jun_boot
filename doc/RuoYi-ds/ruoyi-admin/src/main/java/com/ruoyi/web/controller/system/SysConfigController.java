...
public class SysConfigController extends BaseController {
    ...
    public TableDataInfo list(SysConfig config) {
        startPage();
        SpringContextUtil.getBeans();
        List<SysConfig> list = configService.selectConfigList(config);
        DataSourceHolder.setDataSource("1100101");
        String field = "roleId,name";
        List<Map<String, String>> roles = playerService.selectList(field, "t_role", " 1=1 ", 1, 50, " order by roleId desc");
        List<Map<String, String>> logs = logService.selectList("role_id,currency_id", "log_currency", " 1=1 ", 1, 50, " order by currency_id desc");
