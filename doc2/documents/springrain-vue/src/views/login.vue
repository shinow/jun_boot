<template>
	<div class="login">
		<el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
			<h3 class="title">springrain后台管理系统</h3>
		...
		<div class="el-login-footer">
			<span>Copyright © 2018-2019 springrain All Rights Reserved.</span>
		</div>
	</div>
</template>
	...
	export default {
		...
		methods: {
			getCode() {
				getCodeImg().then(res => {
					console.log(res)
					this.codeUrl = res.result.imageBase64;
					this.loginForm.captchaKey = res.result.captchaKey;
				});
			},
			getCookie() {
