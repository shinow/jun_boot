...
CREATE TABLE `qrtz_blob_triggers`  (
  ...
  `blob_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'DESKTOP-GCTSJEJ1569228453535', 1569228533294, 15000);
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1569228460000, -1, 5, 'PAUSED', 'CRON', 1569228453000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1569228465000, -1, 5, 'PAUSED', 'CRON', 1569228454000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1569228460000, -1, 5, 'PAUSED', 'CRON', 1569228454000, 0, NULL, 2, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 433 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_logininfor` VALUES (426, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-09-16 17:22:52');
INSERT INTO `sys_logininfor` VALUES (427, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-09-16 17:25:37');
INSERT INTO `sys_logininfor` VALUES (428, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-09-16 17:27:33');
INSERT INTO `sys_logininfor` VALUES (429, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-09-23 15:41:59');
INSERT INTO `sys_logininfor` VALUES (430, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-09-23 15:45:33');
INSERT INTO `sys_logininfor` VALUES (431, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-09-23 15:56:35');
INSERT INTO `sys_logininfor` VALUES (432, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-09-23 16:47:42');
...
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_oper_log` VALUES (55, '商城商品分类', 3, 'com.ruoyi.web.controller.shop.StoreGoodsCateController.remove()', 1, 'admin', '研发部门', '/shop/cate/remove/1', '127.0.0.1', '内网IP', '{ }', 0, NULL, '2019-09-23 15:45:39');
INSERT INTO `sys_oper_log` VALUES (56, '商城商品分类', 3, 'com.ruoyi.web.controller.shop.StoreGoodsCateController.remove()', 1, 'admin', '研发部门', '/shop/cate/remove/2', '127.0.0.1', '内网IP', '{ }', 0, NULL, '2019-09-23 15:46:09');
INSERT INTO `sys_oper_log` VALUES (57, '商城商品分类', 3, 'com.ruoyi.web.controller.shop.StoreGoodsCateController.remove()', 1, 'admin', '研发部门', '/shop/cate/remove/3', '127.0.0.1', '内网IP', '{ }', 1, '请先删除子分类', '2019-09-23 15:56:43');
INSERT INTO `sys_oper_log` VALUES (58, '商城商品分类', 3, 'com.ruoyi.web.controller.shop.StoreGoodsCateController.remove()', 1, 'admin', '研发部门', '/shop/cate/remove/3', '127.0.0.1', '内网IP', '{ }', 1, '请先删除子分类', '2019-09-23 15:56:49');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '供货商城', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-09-23 16:47:43', 'admin', '2018-03-16 11:33:00', 'ry', '2019-09-23 16:47:42', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('f28148a5-4c82-4548-9c96-3fcf772c92d5', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2019-09-23 16:47:40', '2019-09-23 16:47:43', 1800000);
