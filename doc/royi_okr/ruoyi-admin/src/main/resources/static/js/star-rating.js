...
(function (factory) {
    ...
    Rating.prototype = {
        ...
        _parseAttr: function (vattr, options) {
            ...
            var self = this,
                ...
                css, cap, capVal, cssVal, caption, vCap = self.starCaptions,
    ...
    $.fn.rating.defaults = {
        ...
        showCaption: true,
        starCaptionClasses: {
            0.5: 'label label-danger', 1: 'label label-danger', 1.5: 'label label-warning', 2: 'label label-warning', 2.5: 'label label-info', 3: 'label label-info', 3.5: 'label label-primary', 4: 'label label-primary', 4.5: 'label label-success', 5: 'label label-success'
        },
