...
CREATE TABLE `sys_dept`  (
  ...
  `parent_id` bigint(16) NULL DEFAULT 0 COMMENT '父部门id',
  ...
  `leader` varchar(20)  NULL DEFAULT '' COMMENT '负责人',
  `phone` varchar(11)  NULL DEFAULT '' COMMENT '联系电话',
  ...
  INDEX `index_dept_jbdm`(`jbdm`) USING BTREE
...
CREATE TABLE `sys_cost_time`  (
  ...
  `method_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '方法名',
  `spend_time` bigint(16) NOT NULL COMMENT '消耗的时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统响应时间统计记录表（方便对响应时间长的进行优化）' ROW_FORMAT = Dynamic;
